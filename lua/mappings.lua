...
-- <C-h/j/k/l> window navigation is owned by vim-tmux-navigator (it loads after
-- this file and maps all four), so it moves between vim splits and tmux panes.
...
set('n', 'N', 'Nzz', { desc = 'center prev search' })
